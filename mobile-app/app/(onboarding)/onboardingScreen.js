        ...
        {pages.map((page, index) => (
          <View key={index} style={styles.page}>
            ...
            <View
              ...
              className="bg-primary-200 rounded-2xl p-10 "
            >
              <Text
                style={styles.title}
                className=" bottom-0 text-center text-5xl font-Inter_500Medium"
              >
                {page.title}
              </Text>
              <Text style={styles.subtitle} className="font-Inter_500Medium">
                {page.subtitle}
              </Text>
            </View>
          </View>
